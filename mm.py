...
proxies={
        "http": "http://ywdtsomb:3j5xn8fnpq9s@198.23.239.134:6540/",
        "https": "http://ywdtsomb:3j5xn8fnpq9s@198.23.239.134:6540/"
    }
...
while True:
    ...
    res = requests.post(url, data=json.dumps(payload), headers=headers,proxies=proxies).json()
    if res["success"]==True:
